...
namespace LibreMcpAddin.Commands
{
    public static class MapCommands
    {
        ...
        {
            return double.IsFinite(value) ? value : (double?)null;
        }
                ...
                foreach (var layer in layers)
                {
                    ...
                    if (layer is FeatureLayer featLayer)
                    {
                        try
                        {
                            ...
                            featureCount = fc != null ? fc.GetCount() : 0;
                        }
        ...
        public static Task<object> SetLayerTransparencyAsync(string layerName, double transparency)
        {
            return QueuedTask.Run<object>(() =>
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("transparency", "Transparency must be between 0 and 100.");
                }

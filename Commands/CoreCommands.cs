...
// trimmed to the Libre subset. Behavior and contracts unchanged.
using System;
...
namespace ArcGisProMcpFree.Commands
{
    ...
    {
        public const string AddinVersion = "0.1.0-libre";
    ...
    public static class ToolNames
    {
        public static readonly IReadOnlyList<string> All = CommandNames.All
            ...
            .Concat(new[]
            {
                // Python-only wrappers that delegate to run_gp_tool.
                // They work unchanged against this Add-In.
                "buffer_analysis",
                "clip_analysis",
                "spatial_join",
                "excel_to_table",
